package com.microsservices.movie.endpoint.controller;


import com.microsservices.core.error.ResourceNotFoundException;
...
public class MovieController {
    ...
    public ResponseEntity<?> save(@Valid @RequestBody Movie movie) {
        ...
        movie.setFk(response.getBody().getId());
    ...
    public ResponseEntity<?> update(@Valid @RequestBody Movie movie) {
        verifyIfStudentExists(movie.getId());
        return new ResponseEntity<>(movieService.save(movie),HttpStatus.CREATED);
    }
